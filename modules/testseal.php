...
if (empty($_POST) OR (isset($_POST['voteanker'])))
{
  $checkboxClickableBewerten="checked";
  $checkboxShowBewerten="checked";
}
else
{
  $checkboxClickableBewerten="";
}

if (empty($_POST) OR (isset($_POST['votecount'])))
{
  $checkboxShowRating="checked";
  $checkboxShowBewerten="checked";
}
else
{
...
if (isset($_POST['submit'])) {
  ...
  $final1 = $url1 . $id . $count . $snippet . $popup . $popupClean . $voteanker .$ankerimage . $votecount . $ankercount;
