...
<%%beginform%%>
<h2 class="rechner-head">Zinsrechner Tagesgeldkonto</h2>
<div class="rechner-form">
	 <script src="http://www.financeads.net/javascript/boxover.js" type="text/javascript"></script>

		<form action="/produkte/tagesgeld" method="post" enctype="multipart/form-data" style="border:0px;margin:0px;padding:0px;display:inline;">
			...
			<td valign="top" width="50%">
				...
				<tr>
					...
					<td width="160" valign="top" class="fa_zeile">Anlagebetrag:<br/><i><small>nur Zahl z.B. 10000</small></i></td>
          <td width="100" class="fa_zeile" align="right" style="white-space:nowrap;">{feld:anlagebetrag} &euro;</td>
			...
			<td width="50%">
				...
				<tr>
					...
					<td width="160" class="fa_zeile">Anlagedauer:<br/><i><small>bitte w&auml;hlen</small></i></td>
					<td width="120" align="right" valign="middle">{feld:laufzeit}</td>
				</tr>
				</table>
			</td>
			</tr>
			<tr><td colspan="2" align="right">
				<center><input type="submit" value="Tagesgeldkonten vergleichen" name="submit" class="fa_button" />
...
<%%begintable_start%%>
	...
	<tr>
	<th colspan="8" class="fa_rahmen">Tagesgeldkonten nach Zinsen*</th>
	</tr>
	<tr class="fa_zeile">
		<th></th>
      ...
      <td align="center" valign="middle">
        ...
        <a href="{freitext1}" rel="follow" onclick="blur()" target="_self" style="text-decoration:none;">
          ...
          <font class="fa_zeile fa_produkt">{produkt}</font>
			...
			<td align="center" valign="middle">{rendite} %</td>
