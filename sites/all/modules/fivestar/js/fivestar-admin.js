// $Id: fivestar-admin.js,v 1.4.2.1 2011/02/06 03:34:29 ezrag Exp $
...
if (Drupal.jsEnabled) {
  $(document).ready(function() {
    ...
    // All the form elements except the enable checkbox and the save button.
    $options = $('#fivestar-node-type-options');
