<article class="tabs-c">
	<ul>
		...
		<li><a href="./">Neue Produkte <i class="icon-money"></i></a></li>
		<li><a href="./">Neue Anbieter <i class="icon-bank"></i></a></li>
	</ul>
	<div>
		<div>
			<ol class="list-g">
			...
			<p class="scheme-g">* Kundenbewertungen (Durchschnitt aus mindestens 99 Bewertungen)</p>
		</div>
		<div>
			<ol class="list-g">
				<?php
		...
		<div>
			<ol class="list-g">
				<?php
				foreach(BCVotings::getNewestProduct() as $nid) {
									
					echo "NID: ".$nid."<br>";
					echo "TITEL: ".$title[1]."<br>";
